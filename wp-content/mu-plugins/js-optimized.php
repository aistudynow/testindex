...
if ( ! function_exists( 'wd4_js_get_script_catalog' ) ) {
    function wd4_js_get_script_catalog(): array {
        ...
        $catalog = array(
           ...
           'lazy-single'         => array(
                'src'       => 'https://aistudynow.com/wp-content/themes/js/lazy-single-media.js',
                'deps'      => array(),
                'versions'  => array( 'default' => '0718.0.0' ),
                'in_footer' => true,
            ),
...
if ( ! function_exists( 'wd4_js_get_allowed_handles_by_context' ) ) {
    function wd4_js_get_allowed_handles_by_context( string $context ): array {
        ...
        $map = array(
            ...
            'search'   => array(),
            'author'   => array(),
            'post'     => array( 'main', 'lazy-single', 'foxiz-core', $defer_handle, 'tw-facade' ),
            'page'     => array( 'main', 'lazy-single', 'foxiz-core', $defer_handle, 'tw-facade' ),
            'other'    => array(),
        );
